...
value_mm2_hap_chain_maize = np.array([0.118, 0.091 + 0.086, 0.266 + 0.256, 0.006, 0.127, 0.050]) * runtime_maize[3] / runtime_maize[0]
value_mm2_hap_chain_btk_maize = np.array([0.205, 0.170 + 0.159, 0.078 + 0.069, 0.011, 0.221, 0.088]) * runtime_maize[4] / runtime_maize[0]
value_mm2_hap_chain_btk_sort_maize = np.array([0.096, 0.193 + 0.196, 0.126 + 0.090, 0.014, 0.261, 0.023]) * runtime_maize[5] / runtime_maize[0]
...
value_mm2_hap_chain_barley = np.array([0.154, 0.112 + 0.077, 0.188 + 0.183, 0.007, 0.238, 0.041]) * runtime_barley[3] / runtime_barley[0]
value_mm2_hap_chain_btk_barley = np.array([0.221, 0.161 + 0.120, 0.041 + 0.041, 0.010, 0.348, 0.057]) * runtime_barley[4] / runtime_barley[0]
value_mm2_hap_chain_btk_sort_barley = np.array([0.077, 0.203 + 0.142, 0.054 + 0.053, 0.013, 0.445, 0.014]) * runtime_barley[5] / runtime_barley[0]
